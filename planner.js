...
const ENGLISH_QUOTES = [
  ...
  { en:"You do not rise to the level of your goals; you fall to the level of your systems.", kr:"목표의 수준까지 오르는 게 아니라, 시스템의 수준으로 떨어질 뿐이다." },
  ...
  { en:"Confidence comes not from always being right, but from not fearing to be wrong.", kr:"자신감은 늘 옳아서 오는 게 아니라, 틀려도 두렵지 않은 데서 온다." },
  ...
  { en:"If you want to go fast, go alone. If you want to go far, go together.", kr:"빨리 가려면 혼자 가고, 멀리 가려면 함께 가라." },
  ...
  { en:"The oak fought the wind and was broken; the willow bent and survived.", kr:"참나무는 바람과 싸우다 부러졌지만, 버드나무는 휘어져 살아남았다." },
  ...
  { en:"Patience is not the ability to wait, but how you act while waiting.", kr:"인내는 기다리는 능력이 아니라, 기다리는 동안 어떻게 행동하느냐다." },
  ...
  { en:"Courage is not the absence of fear, but moving forward despite it.", kr:"용기는 두려움이 없는 게 아니라, 그럼에도 나아가는 것이다." },
  ...
  { en:"What lies behind and before us are tiny matters compared to what lies within us.", kr:"과거와 미래는 내면에 있는 것에 비하면 작은 문제일 뿐이다." },
  ...
  { en:"Keep your face to the sunshine and you cannot see the shadow.", kr:"얼굴을 늘 햇살 쪽으로 향하면 그림자는 보이지 않는다." },
  ...
  { en:"A dream doesn't become reality through magic; it takes sweat, determination, and hard work.", kr:"꿈은 마법으로 이뤄지지 않고, 땀과 결심과 노력으로 이뤄진다." },
  ...
  { en:"It's not the load that breaks you down, it's the way you carry it.", kr:"당신을 무너뜨리는 건 짐이 아니라, 그 짐을 짊어지는 방식이다." },
  { en:"Set your mind on a definite goal and observe how quickly the world stands aside.", kr:"확실한 목표를 세우면 세상이 길을 비켜준다." },
  { en:"Ordinary people believe only in the possible; extraordinary people visualize the impossible.", kr:"보통 사람은 가능한 것만 믿지만, 비범한 사람은 불가능한 것을 그려본다." },
